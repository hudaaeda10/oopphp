...
class Anime extends Produk
{
    ...
    public function getInfoProduk()
    {
        $str = "Anime : " . parent::getInfoProduk() . "| {$this->getLabel()} (Rp. {$this->harga}) = {$this->jmlHalaman} Halaman"; //overriding pada method getInfoProduk
        return $str;
    }
}
...
class Game extends Produk
{
    ...
    public function getInfoProduk()
    {
        $str = "Game : " . parent::getInfoProduk() . "| {$this->getLabel()} (Rp .{$this->harga}) ~ {$this->waktuMain}";
        return $str;
    }
}
...
// studi kasus game 
$produk2 = new Game("Assassin Creed", "Corey May", "Ubisoft", 500000, 100);
